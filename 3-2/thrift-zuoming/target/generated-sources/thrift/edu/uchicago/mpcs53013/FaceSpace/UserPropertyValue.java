...
public class UserPropertyValue extends org.apache.thrift.TUnion<UserPropertyValue, UserPropertyValue._Fields> {
  ...
  public static UserPropertyValue location(Location value) {
    UserPropertyValue x = new UserPropertyValue();
    x.setLocation(value);
    return x;
  }

  public static UserPropertyValue birthday(Date value) {
    UserPropertyValue x = new UserPropertyValue();
    x.setBirthday(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case BIRTHDAY:
        ...
        throw new ClassCastException("Was expecting value of type Date for field 'birthday', but got " + value.getClass().getSimpleName());
      default:
      ...
      switch (setField) {
        ...
        case GENDER:
          if (field.type == GENDER_FIELD_DESC.type) {
            GenderType gender;
            gender = edu.uchicago.mpcs53013.FaceSpace.GenderType.findByValue(iprot.readI32());
            return gender;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            return null;
