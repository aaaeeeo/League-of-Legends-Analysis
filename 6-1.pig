...
FAW_GROUP = GROUP FLIGHTS_AND_WEATHER BY (origin, dest, fog, rain, snow, hail, thunder, tornado);
...
ROUTE_DELAY = UNION CLEAR_S, FOG_S, RAIN_S, SNOW_S, HAIL_S, THUNDER_S, TORNADO_S;
ROUTE_DELAY = FOREACH ROUTE_DELAY GENERATE FLATTEN(group) AS (origin, dest), type, delay, count;
