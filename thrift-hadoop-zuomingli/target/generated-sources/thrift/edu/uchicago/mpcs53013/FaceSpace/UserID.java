...
public class UserID extends org.apache.thrift.TUnion<UserID, UserID._Fields> {
  ...
  public UserID(_Fields setField, Object value) {
  ...
  public static UserID user_id(long value) {
    UserID x = new UserID();
    x.setUser_id(value);
    return x;
  }
